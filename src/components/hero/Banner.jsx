...
const Banner = () => {
  const slides = [
    {
      ...
      description: "Connecting you with skilled caremates in your local area, ensuring compassionate and professional caregiver service for your loved ones.",
    ...
    },
    {
      ...
      description: "Dedicated caregivers to provide emotional and physical support for the seniors of your family with dignity and respect.",
      image: "https://images.unsplash.com/photo-1516307365426-bea591f05011?q=80&w=1200",
    },
    {
      id: 3,
      welcome: "SECURE CHILDHOOD",
      title: "Professional Babysitting Solutions",
      description: "Trusted nannies to ensure your child's safety and growth while you are away. Peace of mind for parents.",
  ...
  return (
    <section className="relative w-full">
      ...
      >
        {slides.map((slide) => (
          <div key={slide.id} className="relative h-[450px] md:h-[600px] lg:h-[750px] w-full">
